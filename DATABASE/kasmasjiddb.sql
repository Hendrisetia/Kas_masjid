...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 09 Jun 2023 pada 11.38
...
--
ALTER TABLE `kas_sosial`
  MODIFY `id_ks` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT untuk tabel `tb_donatur`
--
ALTER TABLE `tb_donatur`
  MODIFY `id_donatur` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
