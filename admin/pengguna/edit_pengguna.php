...
if (isset($_GET['kode'])) {
  ...
  // Menghapus penggunaan password_hash pada kode ini
  $password_asli = $data_cek['password'];
}
...
<div class="card card-success">
  ...
  <div class="col-sm-6">
    <input type="password" class="form-control" id="pass" name="password" placeholder="Masukkan Password Baru" value=""/>
...
if (isset($_POST['Ubah'])) {
  ...
  if ($password !== '') {
    ...
    // Update data dengan password terenkripsi
