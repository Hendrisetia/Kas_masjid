...
<body>
    <?php if (isset($_GET['kode']) && !empty($data_cek)) { ?>
        <center>
            <h2>KWITANSI DONASI KAS MASJID</h2>
            <h3>Masjid At-Taqwa Desa Mojo</h3>
            <p>________________________________________________________________________</p>
            <div style="text-align:left">
                <strong>No. Kwitansi:</strong> <?php echo $_GET['kode']; ?>
            </div>
            <div style="text-align:right">
                <strong>Tanggal:</strong> <?php echo $data_cek['tgl_km']; ?>
            </div>
            <p style="text-align:left"><strong>Untuk Pembayaran:</strong> <?php echo $data_cek['uraian_km']; ?></p>
