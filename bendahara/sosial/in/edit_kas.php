    ...
    <div class="col-sm-4">
        <select name="nm_donatur" id="nm_donatur" class="form-control">
            ...
            while ($data_nm_donatur = mysqli_fetch_array($qnm_donatur)) {
                $selected = ($data_nm_donatur['nm_donatur'] == $data_cek['nm_donatur']) ? 'selected' : '';
                echo "<option value='" . $data_nm_donatur['nm_donatur'] . "' " . $selected . ">" . $data_nm_donatur['nm_donatur'] . "</option>";
            }
            ?>
        </select>
    </div>
