...
<body>
<center>
<h2 style="margin-bottom: 0px;">Laporan Rekapitulasi Kas Sosial Masjid At-Taqwa Desa Mojo<h3>Jl.Mojo Agung Ringinarum Kendal</h3></h2>
<p>Periode: <?php $a=$dt1; echo date("d-M-Y", strtotime($a))?> s/d <?php $b=$dt2; echo date("d-M-Y", strtotime($b))?></p>
